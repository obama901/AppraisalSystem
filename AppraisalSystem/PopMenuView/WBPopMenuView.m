...
- (CGRect)menuFrame {
    CGFloat menuX = [UIScreen mainScreen].bounds.size.width - 85;//开始是-130
    CGFloat menuY = 140 - 20 * WBNUMBER;//开始是180-20*
    CGFloat width = self.menuWidth;
    CGFloat heigh = 20 * WBNUMBER;//开始时是40*
...

{
    ...
    CGFloat location = [UIScreen mainScreen].bounds.size.width;//开始是-55
